...
///
/// "Four network destinations" is a promise this app makes in its README and its SECURITY.md, and
/// without this it is only a description of current behaviour. A 302 from any of them would send
