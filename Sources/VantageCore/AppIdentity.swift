...
/// purchases group under the raw SKU. The panel then shows a row called `20250101_example_app` with
...
/// SKU, so any day where the app did sell teaches the whole window who `20250101_example_app` is,
