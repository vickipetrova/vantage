...
public enum Money {
    ...
    public static func text(for proceeds: [String: Decimal],
        ...
        // Only money that *couldn't* be converted is called out. How a converted figure was
        // priced — published rate, central-bank peg, your own number, Vantage's estimate — is
        // stated once in Settings rather than under every figure on screen.
